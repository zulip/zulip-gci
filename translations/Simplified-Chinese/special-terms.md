...
# This is an edited version of the Zulip doc Chinese.md, added with more terms
## Note(题记)
...
* View – 查看
Formal version of view, just 看 is the informal version

* Home -主页
Means homepage, but the most relevant and common substitute.
